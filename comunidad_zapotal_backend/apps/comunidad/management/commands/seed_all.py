...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('  admin@zapotal.com       / Admin123456 (superuser - Django admin)')
        self.stdout.write('  presidente@zapotal.com  / Zapotal2026  (admin frontend)')
        self.stdout.write('  juan@zapotal.com        / Zapotal2026  (comunero)')
        self.stdout.write('  secretario@zapotal.com  / Zapotal2026  (comunero)')
