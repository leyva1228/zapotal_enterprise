"""Seed de ConfiguracionComunidad con los datos reales del C.P. Zapotal.
...
def main():
    ...
    cfg.nombre_oficial = 'Comunidad Campesina Niño Dios de Zapotal'
    ...
    cfg.descripcion_larga = (
        ...
        'San Esteban Alto y Bajo, Nueva Esperanza del Progreso, Alto Monte y Limón). '
    ...
    cfg.historia_html = (
        ...
        '(creada por Ley 15560 del 12 de mayo de 1965), en la region andino-amazónica de '
    ...
    cfg.mision = (
        ...
        'el desarrollo integral sostenible, la identidad cultural andino-amazónica, '
    ...
    # Mientras el dominio comunidadzapotal.gob.pe no este operativo,
    # los formularios publicos reenvian al buzon temporal declarado
    # en settings.EMAIL_DESTINO_TEMPORAL (ver apps/comunidad/emails.py).
    ...
    cfg.save()
    print(f'[OK] ConfiguracionComunidad singleton (id={cfg.pk}) actualizada.')
    print(f'     Nombre: {cfg.nombre_oficial}')
    print(f'     Ubicacion: {cfg.distrito}, {cfg.provincia}, {cfg.region}')
