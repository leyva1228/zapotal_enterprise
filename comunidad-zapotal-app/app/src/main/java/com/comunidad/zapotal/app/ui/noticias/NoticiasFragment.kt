...
import com.comunidad.zapotal.app.adapter.NoticiaFullAdapter
import com.comunidad.zapotal.app.data.model.Noticia
import com.comunidad.zapotal.app.databinding.FragmentNoticiasBinding
...
class NoticiasFragment : Fragment(R.layout.fragment_noticias) {
    ...
    private fun abrirDetalleNoticia(noticia: Noticia) {
        val intent = Intent(requireContext(), NoticiaDetalleActivity::class.java).apply {
            ...
            putExtra("likeCount", noticia.reacciones_count)
        }
