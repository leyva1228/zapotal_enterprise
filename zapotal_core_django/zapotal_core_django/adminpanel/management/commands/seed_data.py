...
def seed():
    ...
    # ── COMUNEROS (vinculados a usuarios COMUNERO) ──
    ...
    print(f"  ✓ {Comunero.objects.count()} comuneros creados")
    ...
    noticia1 = Noticia.objects.create(
        ...
        contenido="Se ha aprobado el proyecto de mejora de infraestructura para nuestra comunidad. "
        "Las obras comenzarán el próximo mes e incluirán la renovación de parques y veredas.",
        categoria=cat_noticias,
        usuario=admin,
    )
    noticia2 = Noticia.objects.create(
        titulo="Campaña de vacunación gratuita",
        contenido="Este sábado se realizará una campaña de vacunación gratuita en el centro comunal. "
        "Se aplicarán dosis contra la influenza y COVID-19 para todas las edades.",
        categoria=cat_salud,
        usuario=admin,
    )
    noticia3 = Noticia.objects.create(
        titulo="Torneo de fútbol intercomunal",
        contenido="Inscripciones abiertas para el torneo de fútbol intercomunal 2026. "
        "Pueden participar equipos de todas las edades. El campeón recibirá un premio de S/ 2,000.",
    ...
    evento1 = Evento.objects.create(
        ...
        descripcion="Ven y disfruta de los mejores platos típicos preparados por los vecinos. "
        "Habrá música en vivo y sorteos.",
    ...
    evento2 = Evento.objects.create(
        ...
        descripcion="Taller gratuito de pintura para niños de 6 a 12 años. "
        "Materiales incluidos. Cupos limitados.",
        categoria=cat_eventos,
        usuario=admin,
        fecha_evento=timezone.now() + timedelta(days=7),
    )
    print(f"  ✓ {Evento.objects.count()} eventos creados")
    ...
    print(f"  ✓ {Comentario.objects.count()} comentarios creados")
    ...
    print(f"  ✓ {Reaccion.objects.count()} reacciones creadas")
    ...
    Notificacion.objects.create(
        ...
        mensaje="No olvides asistir a la Feria Gastronómica 2026 este fin de semana.",
    ...
    Autoridad.objects.create(
        ...
        descripcion="Presidente electo para el período 2025-2027",
        telefono="999888777",
    ...
    Autoridad.objects.create(
        ...
        descripcion="Vicepresidenta encargada de proyectos sociales",
        telefono="999888776",
    ...
    Autoridad.objects.create(
        ...
        apellidos="Quispe",
        cargo="Tesorero",
        descripcion="Tesorero encargado de la gestión financiera comunal",
        telefono="999888775",
        correo="tesorero@comunidadzapotal.com",
        orden=3,
    )
    print(f"  ✓ {Autoridad.objects.count()} autoridades creadas")
    ...
    ContactoMensaje.objects.create(
        ...
        mensaje="Buenos días, quisiera saber cómo puedo inscribir a mi hijo en el taller de pintura.",
    )
    ContactoMensaje.objects.create(
        nombres="Luis Torres",
    ...
    print(f"  ✓ {ContactoMensaje.objects.count()} mensajes de contacto creados")
    ...
    LibroReclamacion.objects.create(
        ...
        pedido="Podemos empezar con una colecta de libros este mes.",
    )
    print(f"  ✓ {LibroReclamacion.objects.count()} libros de reclamación creados")

    print(f"\n✅ Total: 12 tablas pobladas con datos de prueba!")
